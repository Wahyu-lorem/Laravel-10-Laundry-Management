    ...
    <body class="g-sidenav-show bg-gray-100">
        ...
        <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
            ...
            <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('pelanggan/home') ? 'active' : '' }}" href="/pelanggan/home">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('pelanggan/index') ? 'active' : '' }}" href="/pelanggan/index">
                            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="ni ni-bullet-list-67 text-info text-sm opacity-10"></i>
                            </div>
                            <span class="nav-link-text ms-1">Riwayat Laundry</span>
                        </a>
                    </li>
                    <li class="nav-item">
                            ...
                            <ul class="nav ms-4">
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('pesan') ? 'active' : '' }}" href="/pesan">
                                        ...
                                        <span class="sidenav-normal"> Riwayat Pesan </span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('pesan/create') ? 'active' : '' }}" href="/pesan/create">
                                        <span class="sidenav-mini-icon"> K </span>
                                        <span class="sidenav-normal"> Tambah Pesan </span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                        ...
                        <ul class="navbar-nav justify-content-end">
                            <li class="nav-item d-flex align-items-center position-relative">
                                <a href="#" class="nav-link text-white font-weight-bold px-0" id="notificationDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fa fa-bell me-sm-3"></i>
                                    @if(auth()->user()->unreadNotifications->count() > 0)
                                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger me-3">
                                        ...
                                        <li>
                                            <form method="POST" action="{{ route('notifications.markAsRead') }}">
                                                ...
                                                <button type="submit" class="dropdown-item text-danger">
                                                    <i class="fa fa-trash me-2"></i>Hapus Semua Notifikasi
                                                </button>
                                            </form>
                                        </li>
                                    @endif
            ...
            <div class="card shadow-lg">
                <div class="card-header pb-0 pt-3 ">
                    <div class="float-start">
                        <h5 class="mt-3 mb-0">Manners Configurator</h5>
                ...
                <div class="card-body pt-sm-3 pt-0 overflow-auto">
                    ...
                    <a href="/pelanggan/profile" class="btn btn-outline-primary w-100">
                        Profile
                    </a>
        ...
        <script>
            document.querySelectorAll('.status-select').forEach(select => {
                ...
                const currentPriority = select.querySelector(`option[value="${currentStatus}"]`).dataset.priority;

                select.querySelectorAll('option').forEach(option => {
                    if (option.dataset.priority <= currentPriority) {
