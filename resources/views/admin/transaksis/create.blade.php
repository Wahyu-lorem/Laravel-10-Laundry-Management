                            ...
                            <select class="form-control" id="paket" name="paket" required>
                                @foreach($pakets as $paket)
                                    <option value="{{ $paket->id }}" data-price="{{ $paket->harga }}" data-hari="{{ $paket->lama_pengerjaan }}">
                                        {{ $paket->nama_paket }} - {{ $paket->lama_pengerjaan }}  hari-{{ $paket->deskripsi }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                ...
                <form id="addCustomerForm">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="password" class="form-control" id="password" name="password" value="pelanggan123" placeholder="Masukkan password">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="password_confirmation" class="form-label">Konfirmasi Password</label>
                            <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" value="pelanggan123" placeholder="Konfirmasi password">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
        ...
        $('#addCustomerForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    alert('Pelanggan berhasil ditambahkan dan pesan WhatsApp telah dikirim.');
                },
